...
import {ChevronRight,   ShoppingCart, Monitor, Smartphone,ShoppingBag, Globe,BarChart3, 
  UtensilsCrossed, Home,} from 'lucide-react';import { Link } from 'react-router-dom';
...
export default function LandingPage() {
  ...
  <div className="container mx-auto px-4 sm:px-6 md:px-8 flex flex-col justify-center h-full relative z-20">
    <div className="flex flex-col items-center">
      {/* Text Content - Responsive spacing and sizing */}
      <div className="w-full max-w-xs sm:max-w-lg md:max-w-2xl lg:max-w-3xl xl:max-w-4xl mx-auto mb-8 sm:mb-12 md:mb-16 mt-8 sm:mt-12 md:mt-16 lg:mt-24 xl:mt-12 text-center">
...
<section className="pt-4 pb-6 sm:pt-6 sm:pb-8 md:pt-8 md:pb-10 lg:pt-10 lg:pb-12 xl:pt-12 xl:pb-16 bg-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div>
                <div className="space-y-4 mb-8">
                  <div className="flex items-center space-x-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition duration-300 cursor-pointer border-l-4 border-teal-500">
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition duration-300 cursor-pointer">
                    <div className="w-8 h-8 text-teal-500">
                      <Smartphone size={32} />
                    </div>
